...
effects::Effect("type", glmm.ZInb.min.5.1.1)
(ae <- allEffects(glmm.ZInb.min.5.1.1))
plot(ae)
...
plot(predictorEffects(glmm.ZInb.min.5.1.1, ~ type), axes=list(grid=TRUE))
...
require(emmeans)
emmeans(glmm.ZInb.min.5.1.1, c("wlevel"), data = siteDF, type = "response")
```
\n
\n
...
require(emmeans)
emmeans(glmm.ZInb.min.5.1.1, c("type"), data = siteDF, type = "response")
```
