...
Likelihood ratio tests revealed that the model, in which "wlevel" was dropped from the count data model (glmm.ZInb.min.5.2) gave an associated p-value of 0.8239 but also the lowest AIC (1737) among all models tested. However, dropping "wbtype2" (glmm.ZInb.min.5.1) gave a p-value of 0.5574 (and both wbtype 2 and wlevel are likely to be correlated) so we decide to keep "wlevel" and drop "wbtype2", and test whether dropping another term improves model fit further.  
