...
```{r glmm.ZInb.min.1.4.4.1.5.4.4.1-type, cache=TRUE, eval=FALSE}
require(emmeans)
require(multcomp)

emmeans(glmm.ZInb.min.1.4.4.1.5.4.4.1, c("type"), data = siteDF[complete.cases(siteDF[ , c("temp")]),], type = "response")

tukeyType <- glht(glmm.ZInb.min.1.4.4.1.5.4.4.1, linfct = mcp(type = "Tukey"))
summary(tukeyType)
```
