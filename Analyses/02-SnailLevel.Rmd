...
snailDF.na %>% 
  ...
  labs(x = "Infection Status",
       y = "Individual Count",
       title ="Figure 1: Infection status among analysed Bolinus sp. individuals",
...
```{r collinearity-explanVars-test2, message=FALSE, warning=FALSE, cache=TRUE}
require("PerformanceAnalytics")
require("ggplot2")
require("ggpubr")
...
# Model fitting and selection - 29/4/2022  Update
<br/>
<br/>
...
*We do this using leave-one-out cross-validation (LOOCV) but first we must refit the maximal model dropping each explanatory variable in turn.*
