...
# perform merge
TempSnail2 <-merge(TempSnail1, shehiaRaw, by.x="shehia.x", by.y="shehia", all.x=TRUE)
...
df <- TempSnail2[c("shehia.x", "survey_site", "snail_id", "site.x", "survey.x", "type.x", "zest_arm.x", 
